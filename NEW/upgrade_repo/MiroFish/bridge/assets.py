"""Asset profiles for the MiroFish -> XAUEX bridge."""
...
_ASSET_DATA = json.loads(r'''{
    "XAUUSD": {
        ...
        "project_name": "MiroFish Macro Swarm - XAUUSD",
        "simulation_requirement": "Simulate how current macro, central-bank, positioning, ETF-flow and geopolitical developments are likely to influence XAUUSD over the next 24 to 72 hours. Focus on Federal Reserve signals, US real-rate expectations, inflation surprises, labor-market data, safe-haven demand, central-bank gold demand, bullion liquidity, ETF flows and speculative positioning.",
        "parser_brief": "Translate the swarm output into a directional XAUUSD signal. Gold usually reacts to real-rate expectations, USD direction, safe-haven demand, ETF flows and speculative positioning. Distances must be expressed in USD per ounce so XAUEX can execute the signal directly.",
        "distance_unit": "usd",
    ...
    "WTI": {
        ...
        "project_name": "MiroFish Macro Swarm - WTI",
    ...
    "GBPJPY": {
        ...
        "project_name": "MiroFish Macro Swarm - GBPJPY",
