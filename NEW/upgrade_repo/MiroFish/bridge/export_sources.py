...
from bridge.assets import all_symbols
from bridge.source_registry import get_sources, get_source_map
...
def main() -> None:
    ...
    parser.add_argument('--output-dir', default='bridge/sourcepacks', help='Directory to write files into')
